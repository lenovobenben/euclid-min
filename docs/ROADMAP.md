...
- 新证书由独立 SageMath 10.7 verifier 精确重放为 24 E：9 条直线、15 个圆；
- 两个相邻目标均在第 24 E 首次出现，无重复绘制；
- 相比同一 profile 的 32 E baseline，新的已验证上界降低 8 E；
- profile、证书、验证报告、机器可读依赖 DAG、Schema、来源台账、中文说明和回归测试均已发布；
- 该结果不包含 lower-bound proof，不声称 24 E 全局最优或文献最短。
