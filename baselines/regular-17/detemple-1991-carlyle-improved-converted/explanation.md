# DeTemple 1991 修改版 Carlyle 圆构造的 20 E 转写
...
因此 20 E 是同一 profile 下比原 32 E baseline 短 12 E 的新已验证上界。它不是
...
可折叠圆规基础操作。因此原文修改版的 45 与这里的 20 E 不可直接比较。
...
检查拓扑顺序、引用一致性、构造哈希、总分，以及所有 20 个计费节点均属于
最终目标弦的祖先链。
