# DeTemple 1991 修改版 Carlyle 圆构造的 27 E 转写

## 结论与证据等级

本目录把 DeTemple 论文第 104 页明确给出的两项修改转写为
`regular-17-e-fixed-v1`，并删除被半尺度路线完全取代的完整尺度根分支。
...
因此 27 E 是同一 profile 下比原 32 E baseline 短 5 E 的新已验证上界。它不是
...
可折叠圆规基础操作。因此原文修改版的 45 与这里的 27 E 不可直接比较。
...
检查拓扑顺序、引用一致性、构造哈希、总分，以及所有 27 个计费节点均属于
最终目标圆的祖先链。
